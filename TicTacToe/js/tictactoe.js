...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the x.png (now cannon)is placed in HTML 
            select.style.backgroundImage = 'url("images/cannon2.png")'; 
            //Active player may only be 'X' or 'O', so it not 'X' it must be 'O 
        } else {
            //If activePlayer is euql to 'O', the o.png is placed in HTML 
            select.style.backgroundImage = 'url("images/axe2.png")'; 
        }
    ...
    //This function results in a random square being selected by the comptuer. 
...
function checkWinConditions() {
    ...
    // X 0, 1, 2 condition. 
    else if (arrayIncludes('0X', '1O', '2O')) { drawWinLine(50, 100, 558, 100) }
    // X 3, 4, 5 condition. 
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true is returned and our else if conditoin executes the drawLine() function. 
...
//This function rests the game in the event of a tie or a win. 
function resetGame() {
